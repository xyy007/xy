  ...
  return(
    <div className={styles.whole}>
      <section id= {styles.timeline}>
        <Timeline title='University of Western Australia' degree='Master of Information Technology' degreeDes = 'Software requirement and design, software testing, agile web development, data analysis, cloud computing, machine learning' start = '02/2021' end= '11/2022'/>
